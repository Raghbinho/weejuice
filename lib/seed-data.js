...
// Images : photos maison servies depuis public/juices/.
export const JUICES = [
  {
    slug: "fraise",
    name: "Jus de fraise",
  ...
  },
  {
    ...
    color: "#fde047",
    image: "/juices/banane.jpg",
    base: 5,
  },
  {
    slug: "panache",
    name: "Jus panaché kiwi & fraise",
    description: "Notre mélange signature kiwi et fraise, frais et surprenant.",
    color: "#ec4899",
    image: "/juices/panache.jpg",
    base: 6.5,
  },
  {
    slug: "mojito",
    name: "Jus mojito",
    description: "Citron vert et menthe fraîche, ultra désaltérant. Sans alcool.",
    color: "#22c55e",
    image: "/juices/mojito.jpg",
    base: 6,
  },
  {
    slug: "pasteque",
    name: "Jus de pastèque",
    description: "Pastèque juteuse pressée, légère et rafraîchissante.",
    color: "#fb7185",
    image: "/juices/pasteque.jpg",
    base: 5,
  },
];
